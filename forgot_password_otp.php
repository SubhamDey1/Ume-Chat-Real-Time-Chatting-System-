        ...
        if(isset($_POST['email'])){
            ...
            if($valid_email == 1) {
                ...
                if(mysqli_num_rows($result)==1) {
                    ...
                    $info['email_e'] = "This E-mail id is Not Belong to WebChat";
                    $valid_email = 0;
                }
                mysqli_close($conn);
            }
            ...
            if($valid_email==1) {
                ...
                $msg = "<h1 style='margin-bottom:0px;text-align: center;background: #0d6efd;color:#fff;font-family: Arial, Helvetica, sans-serif;padding:10px;'>WebChat Reset Password Verification OTP</h1> <h3 style='margin:0px;padding:15px 10px;text-align:center;background:#198754;color:#fff;font-family: Arial, Helvetica, sans-serif;'>Verification OTP : {$_SESSION['otp']}</h3>";
                ...
                $mail->IsHTML(true);
                $mail->CharSet = 'UTF-8';
                $mail->Username = "rupamsubham.16@gmail.com";
                $mail->Password = "ezwijzlozddozpxj";
                $mail->SetFrom("rupamsubham.16@gmail.com");
