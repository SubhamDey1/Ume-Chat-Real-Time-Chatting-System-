...
<head>
  ...
  <title>Forgot Password | Ume-Chat</title>
  <style>
    body {
      /* background-color: #000; */
      /* background: url(img/img2/12.png) no-repeat center;
        background-size: 100% 100%; */
      background: #474bff;
      background: -webkit-linear-gradient(40deg, #474bff 0%, #e4c21f 50%, #f46e12 100%);
      background: linear-gradient(40deg, #474bff 0%, #e4c21f 50%, #f46e12 100%);
    }

    #main {
      box-shadow: 0px 0px 8px 2px #000, 0px 0px 8px 2px #fff, 0px 0px 8px 2px #000, 0px 0px 8px 2px #fff, 0px 0px 8px 2px #000;
      padding: 20px;
      border-radius: 10px;
    }
          ...
          <form class="col" id="reset_password_form">
            ...
            <div class="row mt-2">
              <div class="col d-flex justify-content-center">
                <a href="index.php" id="back_to_login" class="transform-a">Back to Login</a>
              </div>
            </div>
          </form>
        </div>
